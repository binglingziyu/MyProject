...
public class ListViewActivity extends Activity{
	...
	String[] urls = new String[]{
			...
			"http://t2.gstatic.com/images?q=tbn:ANd9GcTJixLIo_zlOPOILuxNWc5evK333pZCH8rugaTtv3SZSfiI39T0-3vWYQ", "http://www.idyllicmusic.com/index_files/get_apple-iphone.png", 
			...
			"https://ssl.gstatic.com/android/market/com.rovio.angrybirdsseasons/hi-256-9-347dae230614238a639d21508ae492302340b2ba", "http://androidblaze.com/wp-content/uploads/2011/12/tablet-pc-256x256.jpg", 
			...
			"http://thecustomizewindows.com/wp-",
			"content/uploads/2011/11/Nicest-Android-Live-Wallpapers.png", 
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for(int i=0;i<10000;i++){
			...
			person.setEdit("1656516156");
			person.setText("text");
			person.setText2("text0222");
			person.setImage(urls[i%urls.length]);
			list.add(person);
		}
